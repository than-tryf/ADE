...
package org.eclipse.camf.ui.dialogs;
...
import org.eclipse.camf.ui.internal.ReportProblemSolution;
import org.eclipse.camf.ui.internal.layout.LogExceptionSolution;
import org.eclipse.camf.ui.internal.layout.PackData;
import org.eclipse.camf.ui.internal.layout.PackLayout;
...
public class ProblemDialog extends ErrorDialog {
  ...
  protected void createLabelArea( final Composite parent ) {
    ...
    if ( this.message != null ) {
      ...
      final ScrolledComposite sComp = createListArea( "Message:", parent, 100 ); //$NON-NLS-1$
  ...
  protected void createReasonArea( final Composite parent ) {
    ...
    if ( ( reasons != null ) && ( reasons.length > 0 ) ) {
      ...
      final ScrolledComposite sComp = createListArea( "Reasons:", parent, 200 ); //$NON-NLS-1$
