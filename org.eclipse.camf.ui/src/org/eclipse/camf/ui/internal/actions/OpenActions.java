...
public class OpenActions extends ActionGroup {
  ...
  /**
   * Action for opening Cloud model elements.
   */
   ...
   * 
   * @param part The {@link CloudModelViewPart} for which to create this
   * open action group.
   */
  public OpenActions( final CloudModelViewPart part ) {
