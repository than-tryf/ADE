...
/**
 * A {@link CloudModelContentProvider} that may provide the content
...
public class ConfigurableContentProvider
    extends CloudModelContentProvider {
   ...
   */
  protected boolean isVisible( final ICloudElement element ) {
    ...
    for ( Object obj : rootChildren ) {
      if ( obj instanceof ICloudElement ) {
        IPath rootPath = ( ( ICloudElement ) obj ).getPath();
  ...
  private Object[] filterChildren( final Object[] children ) {
    ...
    if ( children != null ) {
      for ( Object child : children ) {
        if ( ( child instanceof ICloudElement
            && isVisible( ( ICloudElement ) child ) )
  ...
  private Object[] remapElements( final Object parent,
    ...
    for ( Object element : elements ) {
      if ( ( element instanceof ICloudElement ) && ( parent instanceof ICloudContainer ) ) {
        element = remapElement( ( ICloudContainer ) parent,
   ...
   */
  protected Object remapElement( final ICloudContainer container,
    ...
    if ( matchingSegments != childSegments - 1 ) {
      ...
      result = CloudModel.getRoot().findElement( remappedPath );
    }
    return result;
  }
  ...
  private Object[] filterHierarchicalChildrens( final Object[] elements ) {
    ...
    for( Object object : elements ) {
      ...
      if( object instanceof ICloudElement ) {
        ICloudElement gridElement = ( ICloudElement )object;
        ICloudContainer parent = gridElement.getParent();
