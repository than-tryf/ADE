...
import org.eclipse.camf.core.security.ISecurityManager;
import org.eclipse.camf.core.security.ISecurityManagerListener;
import org.eclipse.camf.ui.AbstractAuthTokenUIFactory;
import org.eclipse.camf.ui.IAuthTokenUIFactory;
import org.eclipse.camf.ui.UIAuthTokenProvider;
import org.eclipse.camf.ui.cheatsheets.OpenAuthTokenDialogAction;
...
public class AuthTokenView
   ...
   */
  public static class AuthenticationTokenLabelProvider extends LabelProvider implements ITableLabelProvider, ITableFontProvider {
      ...
      if ( !confirm ) {
        ...
        for ( IAuthenticationToken token : tokens ) {
          try {
            ...
            org.eclipse.camf.ui.internal.Activator.logException( authExc );
          }
        }
        updateActions();
      }
