 ...
 *****************************************************************************/
package org.eclipse.camf.connectors.aws.auth;
...
public class AWSAuthTokenDescription implements IAuthenticationTokenDescription
{
  ...
  private static final String WIZARD_ID = "org.eclipse.camf.connectors.aws.ui.wizards.awsAuthTokenWizard"; //$NON-NLS-1$
  ...
  private AWSCloudProvider awsVo;
   ...
   * @param awsVo
   */
  public AWSAuthTokenDescription( final AWSCloudProvider awsVo ) {
    if( awsVo != null ) {
      this.awsVo = awsVo;
      try {
   ...
   * @return the awsVo
   */
  public AWSCloudProvider getAwsVo() {
    return this.awsVo;
  }
   ...
   */
  public void setAwsVo( final AWSCloudProvider awsVo ) {
    this.awsVo = awsVo;
  }
