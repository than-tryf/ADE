...
import org.eclipse.camf.tosca.InputParametersType1;
import org.eclipse.camf.tosca.OutputParametersType1;
import org.eclipse.camf.tosca.PlanModelReferenceType;
import org.eclipse.camf.tosca.PlanModelType;
 ...
 * <ul>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getPlanModel <em>Plan Model</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getPlanModelReference <em>Plan Model Reference</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getPlanLanguage <em>Plan Language</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPlanImpl#getPlanType <em>Plan Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPlanImpl extends TExtensibleElementsImpl implements TPlan
{
  ...
  public String toString()
  {
    ...
    result.append(name);
    result.append(", planLanguage: "); //$NON-NLS-1$
    result.append(planLanguage);
    result.append(", planType: "); //$NON-NLS-1$
