...
import org.eclipse.camf.tosca.TPropertyMapping;
 ...
 * <ul>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPropertyMappingImpl#getServiceTemplatePropertyRef <em>Service Template Property Ref</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPropertyMappingImpl#getTargetObjectRef <em>Target Object Ref</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TPropertyMappingImpl#getTargetPropertyRef <em>Target Property Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TPropertyMappingImpl extends EObjectImpl implements TPropertyMapping
{
  /**
  ...
  public String toString()
  {
    ...
    result.append(" (serviceTemplatePropertyRef: "); //$NON-NLS-1$
    result.append(serviceTemplatePropertyRef);
    result.append(", targetObjectRef: "); //$NON-NLS-1$
    result.append(targetObjectRef);
    result.append(", targetPropertyRef: "); //$NON-NLS-1$
