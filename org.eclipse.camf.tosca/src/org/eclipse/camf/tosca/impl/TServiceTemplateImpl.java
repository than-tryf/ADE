 ...
 * <ul>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getBoundaryDefinitions <em>Boundary Definitions</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getTopologyTemplate <em>Topology Template</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getPlans <em>Plans</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getSubstitutableNodeType <em>Substitutable Node Type</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TServiceTemplateImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TServiceTemplateImpl extends TExtensibleElementsImpl implements TServiceTemplate
{
  ...
  public String toString()
  {
    ...
    result.append(name);
    result.append(", substitutableNodeType: "); //$NON-NLS-1$
