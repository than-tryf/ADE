...
import org.eclipse.camf.tosca.TBoolean;
import org.eclipse.camf.tosca.TImplementationArtifacts;
import org.eclipse.camf.tosca.TRelationshipTypeImplementation;
import org.eclipse.camf.tosca.TRequiredContainerFeatures;
import org.eclipse.camf.tosca.TTags;
 ...
 * <ul>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getDerivedFrom <em>Derived From</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getRequiredContainerFeatures <em>Required Container Features</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getImplementationArtifacts <em>Implementation Artifacts</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getFinal <em>Final</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getRelationshipType <em>Relationship Type</em>}</li>
 *   <li>{@link org.eclipse.camf.tosca.impl.TRelationshipTypeImplementationImpl#getTargetNamespace <em>Target Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TRelationshipTypeImplementationImpl extends TExtensibleElementsImpl implements TRelationshipTypeImplementation
{
  ...
  public String toString()
  {
    ...
    if (finalESet) result.append(final_); else result.append("<unset>"); //$NON-NLS-1$
    result.append(", name: "); //$NON-NLS-1$
    result.append(name);
    result.append(", relationshipType: "); //$NON-NLS-1$
