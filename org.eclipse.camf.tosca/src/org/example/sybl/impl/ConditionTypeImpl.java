 ...
 * <ul>
 *   <li>{@link org.example.sybl.impl.ConditionTypeImpl#getBinaryRestrictionsConjunction <em>Binary Restrictions Conjunction</em>}</li>
 *   <li>{@link org.example.sybl.impl.ConditionTypeImpl#getUnaryRestrictionsConjunction <em>Unary Restrictions Conjunction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionTypeImpl extends EObjectImpl implements ConditionType
{
  ...
  {
		return SyblPackage.Literals.CONDITION_TYPE;
	}
  ...
  {
		EList<BinaryRestriction> binaryRestrictionsConjunction = (EList<BinaryRestriction>)eVirtualGet(SyblPackage.CONDITION_TYPE__BINARY_RESTRICTIONS_CONJUNCTION);
		if (binaryRestrictionsConjunction == null) {
			eVirtualSet(SyblPackage.CONDITION_TYPE__BINARY_RESTRICTIONS_CONJUNCTION, binaryRestrictionsConjunction = new EObjectContainmentEList<BinaryRestriction>(BinaryRestriction.class, this, SyblPackage.CONDITION_TYPE__BINARY_RESTRICTIONS_CONJUNCTION));
		}
  ...
  {
		EList<UnaryRestriction> unaryRestrictionsConjunction = (EList<UnaryRestriction>)eVirtualGet(SyblPackage.CONDITION_TYPE__UNARY_RESTRICTIONS_CONJUNCTION);
		if (unaryRestrictionsConjunction == null) {
			eVirtualSet(SyblPackage.CONDITION_TYPE__UNARY_RESTRICTIONS_CONJUNCTION, unaryRestrictionsConjunction = new EObjectContainmentEList<UnaryRestriction>(UnaryRestriction.class, this, SyblPackage.CONDITION_TYPE__UNARY_RESTRICTIONS_CONJUNCTION));
		}
  ...
  {
		switch (featureID) {
			case SyblPackage.CONDITION_TYPE__BINARY_RESTRICTIONS_CONJUNCTION:
				return ((InternalEList<?>)getBinaryRestrictionsConjunction()).basicRemove(otherEnd, msgs);
			case SyblPackage.CONDITION_TYPE__UNARY_RESTRICTIONS_CONJUNCTION:
