...
public class CreateSecurityGroupFeature extends AbstractCreateFeature {

  private Object contextObject = null;

  public CreateSecurityGroupFeature( final IFeatureProvider fp ) {
    // set name and description of the creation feature
    super( fp, "Security Group", "Create Security Group" ); //$NON-NLS-1$ //$NON-NLS-2$
  }
