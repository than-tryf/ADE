...
public class AddReadyToUseArtifactFeature extends AbstractAddShapeFeature {
	
	public static final int INVISIBLE_RECT_RIGHT = 6;

	public AddReadyToUseArtifactFeature(IFeatureProvider fp) {
		super(fp);
	...
	// Adds an application component figure to the target object
	  ...
	  public PictogramElement add( final IAddContext context ) {
	    ...
	    RoundedRectangle roundedRectangle;
	    {
	      ...
	      roundedRectangle.setStyle( StyleUtil.getStyleForReadyTemplate(getDiagram()) );
	    ...
	    roundedRectangleSD.setStyle( StyleUtil.getStyleForReadyTemplate(getDiagram()) );
	    ...
	    // SHAPE WITH TEXT
	    {
	      ...
	      text.setStyle( StyleUtil.getStyleForReadyTemplate(getDiagram()) );
	    ...
	    ellipse.setStyle( StyleUtil.getStyleForReadyTemplate(getDiagram()) );
