...
public class UpdateCompositeComponentFeature extends AbstractUpdateFeature {

  public UpdateCompositeComponentFeature( final IFeatureProvider fp ) {
    super( fp );
  }
  ...
  public boolean canUpdate( final IUpdateContext context ) {
    ...
    return ( bo instanceof TServiceTemplate );
  }
  ...
  public IReason updateNeeded( final IUpdateContext context ) {
    ...
    businessName = tServiceTemplate.getName();
