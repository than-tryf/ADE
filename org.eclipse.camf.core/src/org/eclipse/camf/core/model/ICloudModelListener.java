...
/**
 * Definition of an {@link EventListener} listening to {@link ICloudModelEvent}s.
 */
public interface ICloudModelListener extends EventListener {
  
  /**
   * The method is called every time a change in the model occurred and the
