...
public class CloudSoftwareMarketplaceView extends ViewPart {
	...
	class ViewContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object parent) {
			return new String[] { "One", "Two", "Three", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four", "Four" };
		}
	}
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "cy.ac.ucy.linc.CloudSoftwareMarketplace.viewer");
		makeActions();
		hookContextMenu();
